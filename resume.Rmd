...
<i class="fa fa-envelope"></i> robertpikmets@gmail.com 
<i class="fa fa-envelope"></i> linkedin
<i class="fa fa-github"></i> github.com/robertpikmets
<i class="fa fa-phone"></i> +372 5332 7319
...
<div class="tech">
- <b>R</b> - Even this CV is automated and designed in R Markdown. Experience with ggplot2, dplyr, tidyr
...
- <b>Python</b> - Finished online course 6.00.1x, but I'm quite rusty now as I've been using mostly R
- <b>Web development</b> - Experience with HTML, CSS, some JavaScript and Python's Django
</div>
